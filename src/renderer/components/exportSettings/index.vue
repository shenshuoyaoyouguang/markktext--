<template>
  <div class="print-settings-dialog">
    <el-dialog
      ...
      width="500px"
    >
      <h3>{{ $t('dialogs.exportSettings.title') }}</h3>
      <el-tabs v-model="activeName">
        <el-tab-pane :label="$t('dialogs.exportSettings.info.tab')" name="info">
          <span class="text">{{ $t('dialogs.exportSettings.info.message') }}</span>
        </el-tab-pane>
        <el-tab-pane :label="$t('dialogs.exportSettings.page.tab')" name="page">
          <!-- HTML -->
          <div v-if="!isPrintable">
            <text-box
              :description="$t('dialogs.export.page.htmlTitle')"
              :input="htmlTitle"
              :emitTime="0"
          ...
          <div v-if="isPrintable">
            <div v-if="exportType === 'pdf'">
              ...
              <div v-if="pageSize === 'custom'" class="row">
                <div>{{ $t('dialogs.export.page.customSize') }}</div>
              ...
              <bool
                :description="$t('dialogs.export.page.landscape')"
                :bool="isLandscape"
            ...
            <div class="row">
              <div class="description">{{ $t('dialogs.export.page.margin') }}</div>
              <div>
                <div class="label">{{ $t('dialogs.export.page.marginTopBottom') }}</div>
              ...
              <div>
                <div class="label">{{ $t('dialogs.export.page.marginLeftRight') }}</div>
        ...
        <bool
            :description="$t('dialogs.export.style.overwriteFont')"
          ...
          <bool
            :description="$t('dialogs.export.style.autoNumbering')"
        ...
        <el-tab-pane :label="$t('dialogs.export.tabs.theme')" name="theme">
          <div class="text">{{ $t('dialogs.export.theme.desc') }}</div>
          <cur-select
        ...
        <el-tab-pane v-if="isPrintable" :label="$t('dialogs.export.tabs.headerFooter')" name="header">
          <div class="text">{{ $t('dialogs.export.headerFooter.desc') }}</div>
          <cur-select
            :description="$t('dialogs.export.headerFooter.headerType')"
            :value="headerType"
          ...
          <text-box
            v-if="headerType === 2"
            :description="$t('dialogs.export.headerFooter.headerLeft')"
          ...
          <text-box
            v-if="headerType !== 0"
            :description="$t('dialogs.export.headerFooter.headerCenter')"
          ...
          <text-box
            v-if="headerType === 2"
            :description="$t('dialogs.export.headerFooter.headerRight')"
          ...
          <cur-select
            :description="$t('dialogs.export.headerFooter.footerType')"
            :value="footerType"
            :options="headerFooterTypes"
          ...
          <text-box
            v-if="footerType === 2"
            :description="$t('dialogs.export.headerFooter.footerLeft')"
          ...
          <text-box
            v-if="footerType !== 0"
            :description="$t('dialogs.export.headerFooter.footerCenter')"
          ...
          <text-box
            v-if="footerType === 2"
            :description="$t('dialogs.export.headerFooter.footerRight')"
          ...
          <bool
            :description="$t('dialogs.export.headerFooter.customizeStyle')"
          ...
          <div v-if="headerFooterCustomize">
            <bool
              :description="$t('dialogs.export.headerFooter.allowStyled')"
              :bool="headerFooterStyled"
              :onChange="value => onSelectChange('headerFooterStyled', value)"
            ></bool>
            <range
              :description="$t('dialogs.export.headerFooter.fontSize')"
        ...
        <el-tab-pane :label="$t('dialogs.export.tabs.toc')" name="toc">
          <bool
            :description="$t('dialogs.export.toc.includeTopHeading')"
            :detailedDescription="$t('dialogs.export.toc.includeTopHeadingDesc')"
            :bool="tocIncludeTopHeading"
            :onChange="value => onSelectChange('tocIncludeTopHeading', value)"
          ></bool>
          <text-box
            :description="$t('dialogs.export.toc.title')"
            :input="tocTitle"
            :emitTime="0"
